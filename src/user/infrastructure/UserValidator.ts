import { User, UserWithPassword } from '@/user/domain/user'
import { z } from 'zod'
...
export const userWithPasswordPartialValidator = async (user: Partial<UserWithPassword>) =>
  UserWithPasswordSchema.partial().safeParseAsync(user)